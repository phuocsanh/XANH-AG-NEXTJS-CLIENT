    ...
    <div className="min-h-screen bg-orange-50/30 pb-20">
      ...
      <div className="bg-gradient-to-br from-orange-600 to-red-700 pt-5 pb-16 sm:pt-5 sm:pb-24 px-4 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <Link href="/" className="inline-flex items-center gap-2 text-orange-100 hover:text-white mb-6 sm:mb-8 transition-colors text-sm sm:text-base">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 bg-white rounded-[2rem] sm:rounded-[40px] shadow-2xl border border-orange-100 p-1.5 sm:p-8 md:p-12">
            ...
            <div className="grid grid-cols-7 gap-2.5 md:gap-4 mb-4">
              {/* Các ô trống cho ngày của tháng trước để căn chỉnh thứ trong tuần */}
              {Array.from({ length: firstDayOfMonth }).map((_, i) => (
                <div
                  key={`empty-prev-${i}`}
                  className="aspect-square flex flex-col items-center justify-center rounded-xl sm:rounded-2xl bg-transparent border border-transparent"
                />
              ))}
